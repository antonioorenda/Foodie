<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/sl-slide.css">
    ...
    <script src="${pageContext.request.contextPath}/resources/js/vendor/modernizr-2.6.2-respond-1.1.0.min.js"></script>
